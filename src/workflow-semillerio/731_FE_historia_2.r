...
PARAM$RandomForest$semilla  <- 600043    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 600043   # cambiar por la propia semilla
...
fganancia_lgbm_meseta  <- function(probs, datos)
{
  ...
  tbl  <- as.data.table( list( "prob"=probs, "gan"= ifelse( vlabels==1 & vpesos > 1, 117000, -3000 ) ) )
